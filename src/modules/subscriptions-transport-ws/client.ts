import _global from '@ungap/global-this';
const NativeWebSocket = _global.WebSocket || _global.MozWebSocket;

import Backoff from '../../modules/backo2';
import { EventEmitter, ListenerFn } from '../../modules/eventemitter3';
import isString from './utils/is-string';
import isObject from './utils/is-object';
import { ExecutionResult, print, DocumentNode, getOperationAST } from 'graphql';
...
export class SubscriptionClient {
  ...
  private buildMessage(id: string | null | undefined, type: string, payload: any) {
  ...
  private sendMessage(id: string | undefined | null, type: string, payload: any) {
  ...
  private processReceivedData(receivedData: any) {
    ...
    switch (parsedMessage.type) {
      ...
      case MessageTypes.GQL_COMPLETE:
        ...
        handler.call(this, null as any, null);
        break;
      ...
      case MessageTypes.GQL_DATA:
        ...
        this.operations[opId].handler(null as any, parsedPayload);
        break;
